    ...
    <div class="container">
      <div class="row py-5">
        <div class="col">
          ...
          <p>A continuación usaré el <a href="http://php.net/manual/es/function.print-r.php">print_r</a> 
            para mostrarles la información de algunas variables:</p>
          <hr>
          <pre class="my-3"><code><?php print_r($arreglo);?></code></pre>

        <p> puedo consultar el arreglo con un <a href = "http://php.net/manual/es/control-structures.for.php">
          ciclo for </a>.</p>
...
<p>
  ...
  y mi animal favorito es el <?php print($arreglobjeto[animalfavorito]);?>
</p>
          ...
          <hr>
          <p>Lo que sigue es un <a href="https://github.com/profesorfaco/dno037-2018-09/blob/master/data/swapi-planets.csv">
            CSV</a> que armé tomando lo que necesitaba de <a href="https://swapi.co/">SWAPI</a>:</p>
