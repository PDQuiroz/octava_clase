...
<!-- esta es la forma de definir un archivo php-->
...
$arreglo = array("cosa1","cosa2","cosa3");

$arreglobjeto = array("apellidos"=>"Quiroz Rios","nombres"=>"Pablo Domingo","edad"=>"22", 
	"signo"=>"Acuario", "animalfavorito"=>"mapache");
